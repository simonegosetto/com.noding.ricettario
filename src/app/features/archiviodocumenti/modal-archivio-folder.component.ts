...
@Component({
  ...
  template: `
    ...
    <ion-content padding>
      <ion-list>
        <ion-item
          *ngFor="let folder of ricerca.folderList | descrizione: ricerca.searchText"
...
export class ModalArchivioFolderComponent implements AfterViewInit {
  ...
  search() {
    this.gs
      .callGateway(
        'Ayl+LWaNzmB0jK5bAt7dDw2s3Y1r3R3eas1IvS+HvCwtWy0tSVYtWy01yGI+Hwdj8Xd6HsSTttvNfEiaHHnOlhVgEphfAue/5g@@',
        '',
      )
      .subscribe(
        (data) => {
