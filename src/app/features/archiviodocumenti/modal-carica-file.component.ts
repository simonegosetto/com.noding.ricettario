  ...
  template: `
    ...
    <ion-footer>
      <ion-row>
        ...
        >
        <ion-col
          ><ion-button class="button-block" (click)="carica()" [disabled]="file.file === undefined"
            >Carica file</ion-button
          ></ion-col
        >
      </ion-row>
    </ion-footer>
...
export class ModalCaricaFileComponent implements AfterViewInit {
  ...
  private _handleReaderLoaded(readerEvt) {
    ...
    this.gs
      .callGateway(
        'aQWu1SmmaITFs0wPPtAi4mvH+ZEphShyYYeUM98pg4ItWy0tSVYtWy1e+2qzPC9u9O9elSJdaZHz9f7O3jqBQcRNBlkfcApwog@@',
        `'${this.file.file.name}','${this.file.file.name}',${this.file.folderid},${this.file.file.size},'${this.file.file.type}',@out_id`,
      )
      .subscribe(
        (data) => {
