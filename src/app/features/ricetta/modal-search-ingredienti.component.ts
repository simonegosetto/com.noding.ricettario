...
@Component({
  ...
  template: `
    ...
    <ion-content padding>
      <ion-list>
        <ion-item
          *ngFor="let ingrediente of ricerca.ricetteList | descrizione: ricerca.searchText"
...
export class ModalSearchIngredientiComponent implements OnInit {
  ...
  search() {
    if (
      ...
      this.gs
        .callGateway(
          '92Z51ruEBMB16QsGuLCg5IRMITJbElTu04zeQyDQ8hwtWy0tSVYtWy3NfTOuxIemB4ik5YY3EihNRNShSM0huP/3RNSMWzBEiw@@',
          '',
        )
        .subscribe(
          (data) => {
