...
@Component({
  ...
  template: `
    ...
    <ion-content padding>
      <ion-list>
        <ion-item
          *ngFor="let ingrediente of ricerca.ingredientiList"
          style="cursor: pointer"
          (click)="select(ingrediente)"
        >
...
export class ModalSearchIngredienteListinoComponent implements OnInit {
  ...
  search() {
    if (
      ...
      this.gs
        .callGateway(
          'dXBEtMkB3PLRn2LH7MgbpuJfe+O2GZXluu2mGitXWOAtWy0tSVYtWy2WminOAV2ecbjmo5i38HGB03aIxjfUYb5d82FkLu4EGg@@',
