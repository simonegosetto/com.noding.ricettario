...
export class FoodcostPage implements OnInit {
  ...
  estrazioneAlimenti() {
    ...
    this.gs
      .callGateway(
        'PZ1+HZdXNvLpU0AZIUk3rWpubGUzhymuevOJS2VGErUtWy0tSVYtWy0iUErMQX3OPVw/8cT4xk1K8L8Bc9Hoq4rbP3xl4f+TOg@@',
        ``,
      )
      .subscribe(
        (data) => {
          ...
          if (
            this.ricerca.alimentiFullList.length > 0 &&
            this.ricerca.alimentiFullList.length > this.ricerca.pageSize
          ) {
